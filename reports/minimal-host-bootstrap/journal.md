...
- Committed verified host helpers, tests and related instructions as d561bd6, separate from plugin/setup commit 2b7042a. Reviewed 14 files, privacy patterns, authorized existing identity and staged whitespace. This follow-up records those commit IDs without rebuilding or disturbing the user's restarted host.
